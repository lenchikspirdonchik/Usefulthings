...
public class BiologyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        chain = (TextView) root.findViewById(R.id.txt_shain);
        trip = (TextView) root.findViewById(R.id.txt_triplet);
        rachet = (TextView) root.findViewById(R.id.txtrachet);
        Button btn = (Button) root.findViewById(R.id.btn_rachet);
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < scndchain.length; i++) {
                    if (i == scndchain.length - 1)
                        rachet.setText(rachet.getText().toString() + scndchain[i].toString() + "\n");
                    else
                        rachet.setText(rachet.getText().toString() + scndchain[i].toString() + "-");
                }
